...
final class Router implements \Countable
{
     ...
     * Event listeners
     *
     * @var array<string, array<string, \Desperado\ServiceBus\MessageHandlers\Handler>>
     */
     ...
     * Command handlers
     *
     * @var array<string, \Desperado\ServiceBus\MessageHandlers\Handler>
     */
     ...
     */
    public function registerListener($event, callable $handler): void
    {
     ...
     */
    public function registerHandler($command, callable $handler): void
    {
     ...
     *
     * @return array<mixed, \Desperado\ServiceBus\MessageHandlers\Handler>
     */
